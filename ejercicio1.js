...
function ejercicio1 (numInicial, numFinal){
  ...
  var result = 0;
  if(objeto.numInicio == undefined || objeto.numFin == undefined){
...
describe ('prueba 1', function () {
  it ('ejercicio1(1,10) ', function () {
    var rangoMulti = new ejercicio1(1, 10)
    assert.equal(55, rangoMulti);
  });
  it ('ejercicio1(10,1) ', function () {
    var rangoMulti2 = new ejercicio1(10, 1)
    assert.equal(55, rangoMulti2 );
  });
  it ('ejercicio1(VACIO ,1) ', function () {
    var rangoMulti = new ejercicio1("", 1)
    assert.equal('falta valores', rangoMulti2 );
  });
});
